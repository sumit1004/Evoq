...
paymentRouter.post('/organizer/payment-account/connect', authenticateRequest, requireRoles('ORGANIZER', 'ADMIN'), connectPaymentAccount);
paymentRouter.delete('/organizer/payment-account', authenticateRequest, requireRoles('ORGANIZER', 'ADMIN'), deletePaymentAccount);
