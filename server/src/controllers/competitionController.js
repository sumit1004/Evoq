...
export const deleteRound = asyncHandler(async (req, res) => res.json(await service.deleteTournamentRound(Number(req.params.roundId), req.user.id)));
...
export const deleteGroup = asyncHandler(async (req, res) => res.json(await service.deleteRoundGroup(Number(req.params.groupId), req.user.id)));
...
export const deleteMatch = asyncHandler(async (req, res) => res.json(await service.deleteGroupMatch(Number(req.params.matchId), req.user.id)));
export const notifyMatch = asyncHandler(async (req, res) => res.json(await service.notifyMatchSchedule(Number(req.params.matchId), req.user.id)));
